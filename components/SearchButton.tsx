const SearchButton = () => {
  return (
    <>
      <button className="flex cursor-pointer h-6 w-6 md:h-8 md:w-60 border rounded-md overflow-hidden items-center justify-center md:justify-between text-xs md:px-2 shadow-none drop-shadow-none">
