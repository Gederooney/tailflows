...
export default function Footer() {
  return (
    <>
      <footer className="bg-secondary-900 dark:bg-secondary-800">
        <div className="w-full max-w-screen-xl p-4 py-6 mx-auto lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              <a href="/" className="flex items-center text-gray-50">
                <Logo />
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4">
              ...
              <div>
                <h2 className="mb-6 text-sm font-semibold uppercase text-gray-50 ">Suivez nous</h2>
                <ul className="font-medium text-gray-500 dark:text-gray-400">
                  <li className="mb-4">
              ...
              <div>
                <h2 className="mb-6 text-sm font-semibold uppercase text-gray-50">Légal</h2>
                <ul className="font-medium text-gray-500 dark:text-gray-400">
                  <li className="mb-4">
                    <a href="/#" className="hover:underline">
                      Politiques
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <a href="/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                ...
                <span className="sr-only">compte Dribbble</span>
              </a>
            </div>
          </div>
        </div>
