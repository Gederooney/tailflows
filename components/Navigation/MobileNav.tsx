...
const MobileNav = () => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed left-0 top-0 h-full w-full transform bg-gray-50/20 opacity-95 duration-300 ease-in-out dark:bg-secondary-800/20 backdrop-blur-lg dark:opacity-[0.98] z-[20001] ${
