...
import ColorUseCasesProvider from './context/ColorUseCases'
...
export async function generateMetadata({ params }): Promise<Metadata | undefined> {
  return {
    title: "Toutes les Couleurs Tailwind CSS et leurs Cas d'Utilisation",
    description:
      "Explorez toutes les couleurs par défaut de Tailwind CSS et leurs cas d'utilisation. Choisissez le type d'utilisation (texte, fond, bordure, etc.) et obtenez les classes Tailwind equivalentes.",
  }
}

const Page = () => {
  return (
    <ColorUseCasesProvider>
      <section className="mx-auto max-w-7xl py-6 relative">
        <div className="flex flex-col gap-0 space-y-0 py-6">
          {Object.entries(colors).map(([name, shades], index) => {
            return <Row key={index} name={name} color={shades} />
          })}
        </div>
        <Controls />
      </section>
