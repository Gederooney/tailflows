...
const Exemples = ({ shades }: { shades: string[] }) => {
  return (
      ...
      <div className="flex flex-col items-center justify-start w-full gap-8 overflow-scroll md:flex-row">
        <div className="relative mx-auto border-gray-800 dark:border-gray-800 border-[14px] rounded-[2.5rem] h-[600px] w-[300px] shadow-xl overflow-hidden shrink-0 grow-0">
          ...
          <div className="w-[272px] h-[572px] rounded-[2rem] shadow-[-5px_-5px_20px_5px_#00000012,_5px_5px_20px_5px_#0000001a] space-y-6 relative overflow-scroll">
            ...
            <div className="px-2 space-y-3">
              <h2 className="text-center" style={{ color: `${shades[10]}` }}>
                Priorité
              </h2>
            ...
            <span className="absolute bottom-2 h-[3px] w-28 bg-gray-950 rounded-xl left-1/2 -translate-x-1/2 translate-y-1/2 dark:bg-gray-50" />
          </div>
        </div>
        <div className="relative mx-auto border-gray-800 dark:border-gray-800 border-[14px] rounded-[2.5rem] h-[600px] w-[300px] shadow-xl overflow-hidden shrink-0 grow-0">
            ...
            <div className="relative w-full h-full pb-32 space-y-4 overflow-scroll">
              ...
              <div className="px-2 !mt-8">
                <div className="flex items-center justify-between w-full gap-4">
                  <span className="inline-block w-4 h-4" style={{ color: `${shades[5]}` }}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="w-full h-full stroke-current fill-none"
                      viewBox="0 0 24 24"
