    ...
    <div className="max-w-[90rem] mx-auto">
      <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-12">
        ...
        <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-secondary-950 md:text-5xl lg:text-6xl dark:text-gray-50">
          Créer votre propre ombre de portée <span className="sr-only">box-shadow</span>
        </h1>
        <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
          Créer vos propres box shadow pour vos projets. Copiez la config tailwindcss, avec des
          exemple d'utilisations. Si vous souhaitez, copiez le html ou le css pour votre box-shadow
        </p>
      </div>
      ...
      <section className="">
        <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-12">
          ...
          <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
            Ici, nous avons pris la peine de créer la plus grande er longue liste de box shadow avec
        ...
        >
          {exemples.map((shadow) => {
            return (
              <div
                key={shadow.shadow}
                className="relative w-40 h-40 border rounded-md cursor-pointer border-gray-950/10 dark:border-gray-50/10 shrink-0 grow-0 group"
                style={{
                  boxShadow: shadow.vanillaCSS,
                }}
              >
                <div className="flex flex-col items-center justify-center w-full h-full gap-2 sr-only group-hover:not-sr-only">
                  <ActionButton
                    actionMethod={() => {
                      copyToClipboard(`box-shadow: ${shadow.vanillaCSS}`)
                    }}
                    sucessChildren={<span>Copié!</span>}
                    classname="px-3 py-1 text-xs border rounded-md bg-secondary-500 text-gray-50 dark:border-gray-50/10"
                  >
                    <span>css</span>
                  </ActionButton>
                  <ActionButton
